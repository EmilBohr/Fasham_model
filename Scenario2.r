...
image.plot(time/365, param$z, A, ylim = rev(range(param$z)),
           xlab = substitute(paste(bold("Year"))), xaxt = "s", ylab = substitute(paste(bold("Depth [m]"))),
           main = "Bacteria [mmol N/m^3]")
box()

# Vertical distribution throughout the year
...
# Vertical plots of the whole water column
...
for (i in 1:12){  
  ...
  plot(P[mid_of_month[index],], param$z,xlim=c(0,2), ylim = rev(range(param$z)), type = "l",pch = 19, col = "darkseagreen", 
  ...
  lines(Z[mid_of_month[index],], param$z, ylim = rev(range(param$z)), pch = 19, col = "blue3",lwd = 3,type = "l")
  lines(B[mid_of_month[index],], param$z, ylim = rev(range(param$z)), pch = 19, col = "yellow",lwd = 3,type = "l")
  lines(D[mid_of_month[index],], param$z, ylim = rev(range(param$z)), pch = 19, col = "red",lwd = 3,type = "l")
  text(1,150,month[index])
  
}

legend(1.15,600,legend=c("Phytoplankton", "Zooplankton", "Bacteria","Detritus"),col=c("darkseagreen", "blue3", "yellow", "red"),pch = 19,cex = 1)
...
for (i in 1:12){  
  ...
  plot(Pt[mid_of_month[index],1:20], param$z[1:20],xlim=c(0,2.4), ylim = rev(range(param$z[1:20])),type = "l", lwd = 3, col = "darkseagreen", 
       main = paste(as.character(title[i])), ylab = ytitle[i],yaxt=paste(as.character(yax[i])), 
       xaxt=paste(as.character(xax[i])),xlab = xtitle[i])
  lines(Zt[mid_of_month[index],1:20], param$z[1:20], ylim = rev(range(param$z)), pch = 19, col = "blue3",lwd = 3,type = "l")
  lines(Bt[mid_of_month[index],1:20], param$z[1:20], ylim = rev(range(param$z)), pch = 19, col = "yellow",lwd = 3,type = "l")
  lines(Dt[mid_of_month[index],1:20], param$z[1:20], ylim = rev(range(param$z)), pch = 19, col = "red",lwd = 3,type = "l")
  text(1.2,10,month[index],cex=1.2)
  
}

legend(1.3,110,legend=c("Phytoplankton", "Zooplankton", "Bacteria","Detritus"),col=c("darkseagreen", "blue3", "yellow", "red"),pch = 19,cex = 1)
